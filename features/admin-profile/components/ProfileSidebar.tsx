                ...
                <View style={styles.cardContent}>
                    ...
                    <View style={styles.contactInfo}>
                        <View style={styles.contactRow}>
                            <Ionicons name="mail-outline" size={18} color="#9CA3AF" style={styles.contactIcon} />
                            <Text style={styles.contactText} numberOfLines={1}>{d.email}</Text>
                        </View>
                        <View style={styles.contactRow}>
                            <Ionicons name="call-outline" size={18} color="#9CA3AF" style={styles.contactIcon} />
                            <Text style={styles.contactText}>{d.phone}</Text>
                        </View>
                        <View style={styles.contactRow}>
                            <Ionicons name="briefcase-outline" size={18} color="#9CA3AF" style={styles.contactIcon} />
                ...
                <View style={styles.activityList}>
                    {activities.map((a, idx) => (
                        <View key={idx} style={styles.activityItem}>
                            <View style={[styles.activityDot, { backgroundColor: a.isRecent ? '#1976D2' : '#D1D5DB' }]} />
