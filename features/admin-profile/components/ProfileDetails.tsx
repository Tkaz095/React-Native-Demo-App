        ...
        <View style={styles.container}>
            ...
            <View style={styles.card}>
                <View style={styles.cardHeader}>
                    ...
                    <Text style={styles.cardSubtitle}>Chi tiết về tài khoản quản trị viên của bạn trong hệ thống</Text>
                </View>
            ...
            <View style={styles.card}>
                <View style={styles.cardHeader}>
                    ...
                    <Text style={styles.cardSubtitle}>Thông tin đăng nhập và cài đặt bảo mật</Text>
                </View>
                <View style={styles.cardBody}>
                    <View style={styles.row}>
                        <View style={styles.col}>
                    ...
                    <View style={styles.actionBox}>
                        ...
                        <View style={styles.actionContent}>
                            ...
                            <Text style={styles.actionSubtitle}>Bảo vệ tài khoản của bạn</Text>
                        </View>
