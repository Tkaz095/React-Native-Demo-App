    ...
    return (
      ...
      >
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.infoText} numberOfLines={1}>
            {item.speaker} - {item.speakerTitle}
          </Text>
        </View>
      </TouchableOpacity>
    );
      ...
      <View style={styles.searchContainer}>
        ...
        >
          <Ionicons
            name="filter"
            size={20}
            color={activeFilterCount > 0 ? "#1976D2" : "#6B7280"}
          />
          {activeFilterCount > 0 && (
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <Text style={styles.resultCount}>
            Hiển thị {currentEvents.length} / {filteredEvents.length} sự kiện
          </Text>
        }
        ListEmptyComponent={
        ...
        <View style={styles.modalOverlay}>
          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.modalBody}>
              ...
              <View style={styles.chipGroup}>
                ...
                {eventTypes.map((t) => (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.chip,
                      filterType === t.id && styles.chipActive,
                    ]}
                  ...
                  >
                    <Text
                      style={[
                        styles.chipText,
                        filterType === t.id && styles.chipTextActive,
                      ]}
                    >
                      {t.name}
                    </Text>
              ...
              <View style={styles.chipGroup}>
                {["all", "draft", "upcoming", "ongoing", "completed"].map(
                  (status) => (
                    <TouchableOpacity
                      key={status}
                      style={[
                        styles.chip,
                        filterStatus === status && styles.chipActive,
                      ]}
                    ...
                    >
                      <Text
                        style={[
                          styles.chipText,
                          filterStatus === status && styles.chipTextActive,
                        ]}
                      >
                        {status === "all"
                          ? "Tất cả"
