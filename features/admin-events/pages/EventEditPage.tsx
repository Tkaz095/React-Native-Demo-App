...
export default function EventEditPage() {
      ...
      [
        {
          text: "OK",
          onPress: () => {
            // TODO: Implement notification service for event updates
            router.back();
          },
        },
      ],
  ...
  const TypeOption = ({
    ...
    return (
      ...
      >
        <View
          style={[styles.typeRadio, isActive && { borderColor: activeColor }]}
        >
          {isActive && (
            <View
              style={[styles.typeRadioInner, { backgroundColor: activeColor }]}
            />
          )}
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.inputGroup}>
            <Text style={styles.label}>
              Loại sự kiện <Text style={styles.required}>*</Text>
            </Text>
            <View style={styles.typesGrid}>
              <TypeOption
                value="seminar"
                label="Hội thảo"
                subtext="Hội thảo chuyên môn"
                activeColor="#3B82F6"
              />
              <TypeOption
                value="networking"
                label="Networking"
                subtext="Gặp gỡ kết nối"
                activeColor="#A855F7"
              />
              <TypeOption
                value="exhibition"
                label="Triển lãm"
                subtext="Triển lãm sản phẩm"
                activeColor="#F97316"
              />
            </View>
          </View>
          ...
          <View style={styles.inputGroup}>
            <Text style={styles.label}>
              Chủ đề sự kiện <Text style={styles.required}>*</Text>
            </Text>
            <TextInput
              style={styles.input}
          ...
          <View style={styles.row}>
            <View style={[styles.inputGroup, { flex: 1, marginRight: 8 }]}>
              <Text style={styles.label}>
                Tên diễn giả <Text style={styles.required}>*</Text>
              </Text>
              <TextInput
                style={styles.input}
            ...
            <View style={[styles.inputGroup, { flex: 1, marginLeft: 8 }]}>
              <Text style={styles.label}>
                Chức danh <Text style={styles.required}>*</Text>
              </Text>
              <TextInput
                style={styles.input}
                value={formData.speakerTitle}
                onChangeText={(t) =>
                  setFormData({ ...formData, speakerTitle: t })
                }
          ...
          <View style={styles.inputGroup}>
            <Text style={styles.label}>
              Trạng thái sự kiện <Text style={styles.required}>*</Text>
            </Text>
        ...
        {!isNew && (
          <View style={styles.infoAlert}>
            ...
            <Text style={styles.infoAlertText}>
              ...
              Khi cập nhật thông tin sự kiện, hệ thống sẽ tự động gửi thông báo
              cập nhật đến toàn bộ hội viên đã đăng ký tham gia.
            </Text>
          </View>
        )}
      </ScrollView>
