...
export default function MembersPage() {
  ...
  const industries = useMemo(
    () => ["all", ...Array.from(new Set(members.map((m) => m.industry)))],
    [members],
  );
  const regions = useMemo(
    () => ["all", ...Array.from(new Set(members.map((m) => m.region)))],
    [members],
  );
  ...
  const filteredMembers = useMemo(() => {
    return members.filter((member) => {
      ...
      const matchesIndustry =
        filterIndustry === "all" || member.industry === filterIndustry;
      const matchesRegion =
        filterRegion === "all" || member.region === filterRegion;
  ...
  const getTierStyle = (tier: string) => {
    switch (tier) {
      ...
      case "Vàng":
        return { bg: "#FEF9E7", text: "#B89730", border: "#FCE6A8" };
      case "Bạc":
      ...
      >
        ...
        <View style={styles.cardFooter}>
          <View style={styles.badges}>
            ...
            >
              <Text style={[styles.badgeText, { color: tierStyle.text }]}>
                {item.tier}
              </Text>
            </View>
            <View
                ...
                >
                  {industries.map((ind) => (
                    <TouchableOpacity
                      ...
                      style={[
                        styles.chip,
                        filterIndustry === ind && styles.chipActive,
                      ]}
                    ...
                    >
                      <Text
                        style={[
                          styles.chipText,
                          filterIndustry === ind && styles.chipTextActive,
                        ]}
                      >
                        {ind === "all" ? "Tất cả" : ind}
                      </Text>
                ...
                >
                  {regions.map((reg) => (
                    <TouchableOpacity
                      ...
                      style={[
                        styles.chip,
                        filterRegion === reg && styles.chipActive,
                      ]}
                    ...
                    >
                      <Text
                        style={[
                          styles.chipText,
                          filterRegion === reg && styles.chipTextActive,
                        ]}
                      >
                        {reg === "all" ? "Tất cả" : reg}
                      </Text>
                ...
                <View style={styles.chipWrap}>
                  {tiers.map((tr) => (
                    <TouchableOpacity
                      ...
                      style={[
                        styles.chip,
                        filterTier === tr && styles.chipActive,
                      ]}
                    ...
                    >
                      <Text
                        style={[
                          styles.chipText,
                          filterTier === tr && styles.chipTextActive,
                        ]}
                      >
                        {tr === "all" ? "Tất cả" : tr}
                      </Text>
